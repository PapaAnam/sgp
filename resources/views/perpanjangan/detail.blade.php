...
@include('static', ['value'=>$d->order->jumlah_tebus_rp,'label'=>'Jumlah Pelunasan'])
<div class="text-success">
	...
	@include('static', ['value'=>$d->jumlah_tebus_rp,'label'=>'Jumlah Pelunasan Baru'])
	@include('static', ['value'=>$d->jumlah_bayar_rp,'label'=>'Total Bayar Perpanjangan'])
</div>
<div class="row">
	<div class="col-md-12">
